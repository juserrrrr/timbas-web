...
export function ImpersonationBanner() {
  ...
  return (
    <div className="mr-auto flex min-w-0 items-center gap-2 rounded-lg border border-amber-500/30 bg-amber-500/10 px-2.5 py-1.5 text-[11px] text-amber-100">
      ...
      <button onClick={() => { if (endImpersonation()) window.location.assign('/admin/access') }} className="ml-1 inline-flex shrink-0 items-center gap-1 rounded-md bg-amber-400 px-2 py-1 font-bold text-black hover:bg-amber-300">
