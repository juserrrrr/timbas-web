  ...
  return (
    <Card className="w-full max-w-md border-gray-800 bg-gray-900/50 p-8 backdrop-blur-sm">
      <div className="mb-8 text-center">
        ...
        <p className="text-sm text-gray-400">Entre com sua conta do Discord para acessar o ranking</p>
      </div>
      ...
      <Button
        ...
        disabled={isLoading}
        className="w-full bg-[#5865F2] py-6 text-lg font-semibold hover:bg-[#4752C4] disabled:opacity-50"
      >
