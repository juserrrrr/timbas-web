...
export function NavigationProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <NavigationContext.Provider value={{ start: () => setPending(true) }}>
      {children}
      {pending && (
        <div className="fixed bottom-0 left-0 right-0 top-14 z-30 flex items-center justify-center bg-[#050508]/80 backdrop-blur-sm animate-in fade-in duration-150 md:left-14">
