...
export const AWARD_CARD_CONFIG: Record<AwardCardKey, AwardCardConfig> = {
  artilheiro: { title: "ARTILHEIRO", value: "12 GOLS", image: "/images/awards/artilheiro-template-v12.png", color: "#ffbd35", highlight: "#fff0b0", font: "teko", nickX: 0.42, nickY: 0.736, statX: 0.42, statY: 0.81, qrX: 0.667, qrY: 0.72, ...shared },
  ...
  xerife: { title: "XERIFE", value: "31 DESARMES", image: "/images/awards/xerife-template-v12.png", color: "#e2e8f0", highlight: "#ffffff", font: "graduate", nickX: 0.406, nickY: 0.716, statX: 0.406, statY: 0.794, qrX: 0.654, qrY: 0.7, ...shared },
