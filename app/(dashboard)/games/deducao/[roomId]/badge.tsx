 ...
 * O crachá.
 *
 * A ficha de cada jogador é a mesma peça em toda a partida: na sala de espera
 * mostra quem chegou, na reunião é o que a pessoa escolhe para votar, e no fim
 * ele vira do avesso e revela o papel de quem estava ali. Um objeto só, do
 * mundo do jogo, fazendo três trabalhos.
 */
      ...
      {stamp && (
        <span
          className={cn(
            ...
            stamp === "morto"
              ? "border-red-500/60 text-red-400/80"
              : "border-amber-400/60 text-amber-300/80",
          )}
        >
          {stamp === "morto" ? "Falecido" : "Demitido"}
        </span>
      )}
