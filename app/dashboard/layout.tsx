  ...
  return (
    <ServerProvider>
      ...
      <div className="relative min-h-screen bg-[#050508] text-white">
        ...
        {/* Top bar */}
        <header className="fixed left-0 right-0 top-0 z-40 flex h-14 items-center justify-end gap-3 border-b border-white/[0.06] bg-[#050508]/80 px-6 backdrop-blur-xl md:left-[65px]">
          <ServerSelector />
          <div className="h-6 w-px bg-white/[0.08]" />
          <UserMenu />
        </header>

        <main className="pt-14 min-h-screen pb-14 md:ml-[65px] md:pb-0">
